...
export default function PlansPage() {
  ...
  const plans = [
    ...
    },
    {
      ...
      badge: "基礎から整える",
      description:
        "英語学習を再スタートしたい方向けのプランです。最初の3か月で、目標・弱点・学習リズムを整理し、無理なく続けるための土台を作ります。",
      points: [
      "目標・弱点・学習リズムを整理",
      "英語の学び直し・基礎整理におすすめ",
      "目安：月2回ペースで無理なく継続",
    ...
    },
    {
      ...
      recommended: true,
      description:
        "継続して英語力を伸ばしたい社会人向けの基本プランです。進捗と次にやることを見える化しながら、TOEIC・英会話・ビジネス英語を目的に合わせてバランス良く進めます。",
      points: [
      "進捗と次にやることを見える化",
    ...
    },
    {
      ...
      badge: "実務で使う方向け",
      description:
        "会議・メール・面接・プレゼン・英文資料など、仕事で英語を使う方向けのプランです。実際の業務シーンに合わせて、伝わる英語・相手を動かす英語を実践的にサポートします。",
      points: [
    "英文メール・会議・プレゼン対策",
    "英語面接や転職準備にも対応",
    "目安：セッションとレビューを組み合わせて活用",
  ],
    },
    {
      name: "短期集中プラン",
      ...
      badge: "集中して進めたい方へ",
      description:
        "期限がある目標に向けて、短期間で英語力を仕上げたい方向けの集中プランです。TOEIC・英語面接・プレゼン・転職準備など、目標日から逆算して優先順位を整理しながら進めます。",
      points: [
        "目標日から逆算した学習設計",
        "TOEIC・英語面接・プレゼン対策に対応",
        "課題・回答・実践アウトプットレビューにも対応",
      ],
    },
  ];
        ...
        <div className="mx-auto max-w-5xl px-5">
          <div className="mx-auto mb-7 max-w-3xl text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl leading-8 text-slate-600">
              まずは近い目的から確認してみてください。プランは学習状況に合わせて見直しできます。
            </p>
          </div>
          ...
          <div className="rounded-[2rem] bg-white p-5 shadow-sm ring-1 ring-slate-200 sm:p-6">
            <div className="grid gap-3">
              {choiceGuide.map((item) => (
                <div
                  key={item.title}
                  className="grid gap-2 rounded-2xl bg-slate-50 px-4 py-4 sm:grid-cols-[180px_1fr] sm:items-center"
                >
            ...
            <div className="mt-5 rounded-2xl bg-blue-50 p-4 text-center ring-1 ring-blue-100">
