...
export default function BuddyEnglishStudioWebsite() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "はい。那覇市・沖縄市・宜野湾市周辺を中心に、対面レッスンもご相談可能です。場所により別途費用が発生する場合があります。",
    },
    {
    ...
    },
    {
      ...
      a: "はい。沖縄 TOEIC対策、英会話、ビジネス英語を、目的に合わせて組み合わせることができます。",
    },
    {
        ...
        <div className="relative mx-auto grid max-w-7xl gap-14 px-5 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-8 max-w-xl text-lg leading-8 text-slate-600 sm:text-xl">
              英語を学び直したい大人、TOEICスコアを上げたい方、仕事で英語を使いたい方へ。TOEIC 990点満点・米国勤務経験・外資ITでの実務経験をもとに、英語を「資格・仕事・人生」に活かすための1対1サポートを行います。
