...
<nav className="hidden gap-7 text-sm font-bold text-slate-600 lg:flex">
  ...
  >
    LINEで無料相談する
      ...
      <section className="relative overflow-hidden bg-white pt-8 pb-10 lg:pt-10 lg:pb-14" aria-labelledby="hero-heading">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-5 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
<div>
